    ...
    def Chi2(omega):
        ...
        for a in range(Ndimension):
            for b in range(Ndimension):
                #dummy2[...,m,n]+=-np.einsum('ij...,jk...->ik...',p[...,m]/(deltaE/hbar+1j*gamma),p[...,n])+np.einsum('ij...,jk...->ik...',p[...,n],p[...,m]/(deltaE/hbar+1j*gamma))
                dummy2[...,a,b]+=-np.einsum('ij...,jk...->ik...',p[...,b],p[...,a]/(deltaE/hbar+1j*gamma))+np.einsum('ij...,jk...->ik...',p[...,a]/(deltaE/hbar+1j*gamma),p[...,b])
