...
@njit
def H(i,kx,ky):
    a,e1,e2,t0,t1,t2,t11,t12,t22,r0,r1,r2,r11,r12,u0,u1,u2,u11,u12,u22,lam=para(i)
...
def Vpkx(i,kx,ky):
    delta=1e-5
    return (np.array(H(i,kx+delta,ky), dtype='complex128')-np.array(H(i,kx-delta,ky),dtype='complex128'))/(2*delta)
@njit
def Vpky(i,kx,ky):
    delta=1e-5
    return (np.array(H(i,kx,ky+delta), dtype='complex128')-np.array(H(i,kx,ky-delta),dtype='complex128'))/(2*delta)