...
module globalvar
    ...
    module para_MX2
     ...
     module varia
        ...
        double complex ,dimension(0:Norbital,0:Norbital,0:nkamax,0:nkamax,0:1),intent(out) :: ps, xis
        ...
        double complex,dimension(0:Norbital,0:Norbital,0:nkamax,0:nkamax),intent(out) :: Vs
